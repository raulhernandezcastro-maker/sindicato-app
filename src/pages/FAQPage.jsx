    ...
    <div className="space-y-6 max-w-3xl mx-auto">
      ...
      <div className="flex items-center justify-between px-4 py-3 rounded-lg"
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-xs text-green-100">Consultas habituales del sindicato</p>
          </div>
        </div>
        {isAdministrador && (
          ...
          {faqs.map((faq, i) => (
            <div key={faq.id} className="rounded-lg border overflow-hidden shadow-sm">
              ...
              <button
                ...
                style={{
                  backgroundColor: openIdx === i ? '#2d7a4f' : '#f0f9f2',
              ...
              >
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  {isAdministrador && openIdx !== i && (
                    <>
                      <span
                        ...
                        className="p-1 rounded hover:bg-green-200 cursor-pointer"
                        title="Editar"
                      >
                        <Pencil className="w-3.5 h-3.5" style={{ color: '#2d7a4f' }} />
                      </span>
                      <span
                  ...
                  {openIdx === i
                    ...
                    : <ChevronDown className="w-4 h-4" style={{ color: '#2d7a4f' }} />
                  }
                </div>
              </button>
      ...
      <Dialog open={modalOpen} onOpenChange={setModalOpen}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle style={{ color: '#2d7a4f' }}>
          ...
          <div className="space-y-4 pt-2">
            ...
            <div>
              <Label style={{ color: '#2d7a4f' }} className="font-semibold">Pregunta</Label>
              <Input
                className="mt-1"
            ...
            <div>
              <Label style={{ color: '#2d7a4f' }} className="font-semibold">Respuesta</Label>
              <textarea
                className="mt-1 w-full border rounded px-3 py-2 text-sm focus:outline-none resize-none"
                style={{ borderColor: '#2d7a4f', minHeight: '120px' }}
