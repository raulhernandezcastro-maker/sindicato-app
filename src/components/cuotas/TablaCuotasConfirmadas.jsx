  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-lg border overflow-hidden shadow-sm">
        <div className="flex items-center gap-2 px-4 py-2" style={{ backgroundColor: '#2d7a4f' }}>
          <BarChart2 className="w-4 h-4 text-white" />
          <span className="text-white text-sm font-semibold">Resumen por Período</span>
        </div>
        <div style={{ backgroundColor: '#f0f9f2' }}>
          {loading ? (
                ...
                <tbody>
                  {resumenPorPeriodo.length === 0 ? (
                    ...
                    resumenPorPeriodo.map(r => (
                      <tr key={r.periodo} className="hover:bg-green-50 transition-colors">
                    ...
                    <tr key={r.id} className="hover:bg-green-50 transition-colors">
                      ...
                      <TD>
                        <span className="px-2 py-0.5 rounded-full text-xs font-semibold"
                              style={{
                                backgroundColor: r.tipo === 'SOCIO' ? '#d4edda' : '#d6eaf8',
                                color: r.tipo === 'SOCIO' ? '#2d7a4f' : '#1a5276'
                              }}>
                          {r.tipo}
                        </span>
                      </TD>
