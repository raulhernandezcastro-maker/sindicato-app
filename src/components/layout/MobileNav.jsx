    ...
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-3 border-b md:hidden"
        ...
        <div className="flex items-center gap-2 min-w-0">
          <img src="/logo.png" alt="Logo" className="w-13 h-13 object-contain rounded-full shrink-0" />
          <div className="min-w-0">
            <p className="text-white text-sm font-bold leading-tight truncate">
              Sindicato Interempresas
            </p>
            <p className="text-green-100 text-sm font-semibold leading-tight truncate">
              Liberty Seguros
            </p>
          </div>
        </div>
          ...
          <div className="absolute left-0 top-0 bottom-0 w-72 flex flex-col shadow-xl"
                ...
                return (
                  <Link
                    ...
                    className={cn(
                      ...
                      isActive ? 'text-green-900' : 'text-green-100 hover:bg-green-700 hover:text-white'
                    )}
                    style={isActive ? { backgroundColor: '#7CBE80' } : {}}
                  >
            ...
            <div className="p-4 border-t border-green-700">
              <button
                ...
                className="w-full flex items-center gap-3 px-3 py-3 rounded-lg text-sm font-medium text-white hover:bg-green-700 transition-colors"
              >
          ...
          {barLinks.map(({ to, icon: Icon, label }) => {
            ...
            return (
              <Link
                ...
                style={isActive ? { color: '#7CBE80' } : { color: 'rgba(255,255,255,0.7)' }}
              >
