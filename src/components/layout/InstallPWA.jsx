      ...
      >
        <div className="flex items-start gap-3 p-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-green-200 text-xs mt-0.5 leading-tight">
        ...
        <div className="px-4 pb-4 flex gap-2">
          ...
          <button
            ...
            className="px-3 py-2 rounded-lg text-xs text-green-200 hover:text-white"
          >
            Ahora no
          </button>
        </div>
          ...
          <div className="px-5 py-4 flex items-center justify-between"
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-green-200 text-xs">Sindicato Liberty Seguros</p>
              </div>
            </div>
          ...
          <div className="p-5 space-y-4">
            ...
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 rounded-full flex items-center justify-center shrink-0 text-white text-sm font-bold"
                   style={{ backgroundColor: '#2d7a4f' }}>1</div>
              <div className="flex-1">
                ...
                <div className="mt-2 flex items-center justify-center w-10 h-10 rounded-lg border-2"
                  ...
                  <Share className="w-5 h-5" style={{ color: '#2d7a4f' }} />
                </div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 rounded-full flex items-center justify-center shrink-0 text-white text-sm font-bold"
                   style={{ backgroundColor: '#2d7a4f' }}>2</div>
              <div className="flex-1">
            ...
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 rounded-full flex items-center justify-center shrink-0 text-white text-sm font-bold"
                   style={{ backgroundColor: '#2d7a4f' }}>3</div>
              <div className="flex-1">
