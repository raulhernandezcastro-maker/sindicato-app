...
const WHATSAPP_MESSAGE = encodeURIComponent('Hola, me contacto desde el portal del Sindicato Interempresas Liberty Seguros.')
const DENUNCIAS_URL    = 'https://www.sindicatoliberty.com/denuncias.html'
...
export default function WhatsAppButton() {
  ...
  return (
    <>
      ...
      <div style={{ position: 'fixed', bottom: '80px', right: '16px', zIndex: 9998, display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '10px' }}>
        ...
        <button
          ...
          style={{
            ...
            backgroundColor: abierto ? '#1e3a2f' : '#25D366',
